                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <div class="list-icons">
                                                            ...
                                                            <a href="/clientes/delete?ent_id={{$entidad->ent_id}}" class="list-icons-item text-danger-600"><i class="icon-trash"></i></a>
                                        ...
                                        <div class="form-group">
                                            <div class="row">
                                                ...
                                                <div class="col-xl-6">
                                                    ...
                                                    <input type="text" name="ent_telf" class="form-control" placeholder="INgrese Teléfono">
                                                </div>
